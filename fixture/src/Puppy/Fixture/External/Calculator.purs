...
-- silently ignored.
module Puppy.Fixture.External.Calculator
  ( total
  , totalFrom
  ) where
...
puppyIndexOf = case _, _ of
  ...
  true, Puppy.Deps.Just (T.At _ T.Times) -> 1
  true, Puppy.Deps.Just (T.At _ (T.Number _)) -> 2
  true, Puppy.Deps.Just (T.At _ (T.Comment "$$")) -> 3
  true, Puppy.Deps.Nothing -> 4
  _, _ -> 5
...
puppyValueOf = case _, _ of
  ...
  true, Puppy.Deps.Just (T.At _ T.Times) -> Puppy.Runtime.box unit
  true, Puppy.Deps.Just (T.At _ (T.Number puppyPayload)) -> Puppy.Runtime.box puppyPayload
  true, Puppy.Deps.Just (T.At _ (T.Comment "$$")) -> Puppy.Runtime.box unit
...
total :: Array (T.Token) -> Puppy.Deps.Either (Puppy.Runtime.ParseError (T.Token)) (Int)
total puppyInput =
...
totalFrom
  ...
  -> m (Puppy.Deps.Either (Puppy.Runtime.ParseError (T.Token)) (Int))
totalFrom puppyNext =
