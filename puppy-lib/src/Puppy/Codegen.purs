...
-- |
-- | Exported because the generator is not the only thing that needs it: what
-- | tells a file Puppy wrote from one somebody wrote by hand is that it begins
-- | with this, and something has to know that before overwriting anything.
marker :: String
marker = "-- Generated by Puppy. Do not edit."
